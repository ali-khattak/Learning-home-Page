    ...
    <div className="py-16 bg-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center items-center mb-4">
          <img
            src="/public/theresa-webb.png" // Use appropriate image path
            alt="Theresa Webb"
        ...
        <div className="flex justify-center space-x-4">
          <img
            src="/public/P3.svg" // Use appropriate image path
            alt="Reviewer 1"
            className="w-10 h-10 rounded-full"
          />
          <img
            src="/public/P4.svg" // Use appropriate image path
            alt="Reviewer 2"
            className="w-10 h-10 rounded-full"
          />
          <img
            src="/public/P5.svg" // Use appropriate image path
            alt="Reviewer 3"
            className="w-10 h-10 rounded-full"
          />
          <img
            src="/public/P6.svg" // Use appropriate image path
            alt="Reviewer 4"
            className="w-10 h-10 rounded-full"
          />
        </div>
