  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl text-[#003C3C] font-bold text-center mb-12">
          How KnowledgePulse <span className="text-[#003C3C]">works</span>
        </h2>
        <div className="flex flex-wrap justify-center -mx-4">
          {/* Card 1 */}
          <div className="w-full md:w-1/3 px-4 mb-8 md:mb-0">
            <div className="border-2 border-[#71A795] rounded-lg p-6 text-center shadow-lg relative">
              <img
                src="/signin-icon.svg"
                alt="Signin Icon"
              ...
              <button className="bg-[#003C3C] text-white px-4 py-2 rounded">
                Get Started
              </button>
            </div>
          </div>
