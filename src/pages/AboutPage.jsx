...
import Mentors from '../components/Mentors'; // Adjust the import path as needed
...
const AboutPage = () => {
  return (
    <div>
      {/* Vision Section */}
      <section className="bg-green-50 min-h-screen  items-center justify-center">
      <div className="container mx-auto w-11/12 md:w-[95%]" >
  <div className="bg-[#000c34] rounded-lg p-20 text-center relative overflow-hidden">
